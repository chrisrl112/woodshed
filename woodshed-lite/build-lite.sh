...
cp "$ROOT/assets/warmups/arban-slur-08.png" "$ROOT/assets/warmups/arban-major-scales.png" "$DIST/assets/warmups/" 2>/dev/null || echo "      (warmup images missing — carousel image slides will 404)"
