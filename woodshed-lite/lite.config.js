...
window.WSL_CONFIG = {
  ...
  warmups: [
    ...
    },
    {
      ...
      label: 'Arban · Studies on the Slur, Nos. 7–10',
    ...
    {
      id: 'arban-major-scales', type: 'image',
      label: 'Arban · Major Scales',
      badge: 'PUBLIC DOMAIN · 1893',
      src: 'assets/warmups/arban-major-scales.png',
      marking: 'Even, clean sixteenths · start slow, let every scale ring to the top',
      defaultBpm: 88, bpmMin: 40, bpmMax: 168, reps: 5,
    },
  ],
